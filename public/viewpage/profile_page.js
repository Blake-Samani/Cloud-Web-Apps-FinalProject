...
export async function profile_page(){
	...
	<tr>
			...
			<td width="60%">
				<input type ="text" name="creditNo" value="${accountInfo.creditNo}"
					placeholder="16 digits" disabled required
					pattern="[0-9]+"
	...
	<table>
		<tr>
			...
			<td>
				<button id="profile-photo-update-button" class="btn btn-outline-danger">UpdatePhoto</button>
		</tr>
	</table>
	`;
...
function actionButtons(){
	return `
		...
		<button onclick="this.form.submitter='Update'"
			type="submit" class="btn btn-outline-primary" style="display: none;">Update</button>
		<button onclick="this.form.submitter='Cancel'" formnovalidate="true"
			type="submit" class="btn btn-outline-primary" style="display: none;">Cancel</button>
